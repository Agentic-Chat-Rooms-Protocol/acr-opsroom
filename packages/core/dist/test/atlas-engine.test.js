...
describe('Atlas2Engine Deliberation & State Machine', () => {
    ...
    test('initializes an incident in detecting phase with live canvas', () => {
        const incident = Atlas2Engine.createIncident('Redis Cluster Memory Fragmentation', 'Memory usage exceeded 94% with evictions on cache tier', squad);
    ...
    test('records deliberation turn with cryptographic signature', () => {
        ...
        const turn = Atlas2Engine.addDeliberationTurn(incident, squad.agents[1], 'Hypothesize connection pool exhaustion in database driver', 'Exhausted connection pool', [
            {
    ...
    test('compiles execution plan and runs dry-run simulation', () => {
        ...
        Atlas2Engine.addDeliberationTurn(incident, squad.agents[1], 'Restart idle connections', undefined, [
            {
    ...
    test('dry-run simulation blocks dangerous irreversible commands', () => {
        ...
        Atlas2Engine.addDeliberationTurn(incident, squad.agents[0], 'Dangerous proposal', undefined, [
            {
...
//# sourceMappingURL=atlas-engine.test.js.map