...
export type IncidentStatus = 'detecting' | 'deliberating' | 'awaiting_quorum' | 'executing' | 'verifying' | 'resolved' | 'mitigated' | 'escalated_human' | 'aborted';
...
export type AgentRole = 'atlas_orchestrator' | 'sre_reliability' | 'secops_guardian' | 'dataops_engineer' | 'finops_overseer' | 'compliance_auditor';
...
export type DeliberationPhase = 'detect' | 'ground' | 'deliberate' | 'quorum' | 'execute' | 'verify' | 'completed' | 'vetoed';
...
export type SandboxProfile = 'no-network' | 'egress-allowlist' | 'readonly-fs' | 'workspace-scoped';
