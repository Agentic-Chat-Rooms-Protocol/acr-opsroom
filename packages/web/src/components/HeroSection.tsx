...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section 
      ...
      className="relative pt-12 pb-16 px-4 lg:px-8 max-w-7xl mx-auto overflow-hidden"
    >
      <div className="text-center max-w-4xl mx-auto">
        {/* Top Tagline */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.04] border border-white/10 text-xs font-semibold text-slate-300 mb-6 backdrop-blur-md">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
          <button
            ...
            className="touch-target px-6 py-3 rounded-xl bg-[#00f0ff] text-black font-bold text-sm hover:bg-[#38f8ff] shadow-lg shadow-[#00f0ff]/25 flex items-center gap-2 transition-all hover:scale-[1.02]"
          >
          ...
          <button
            ...
            className="touch-target px-6 py-3 rounded-xl border border-white/15 bg-white/[0.04] text-white font-semibold text-sm hover:bg-white/[0.08] transition-all"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 backdrop-blur-md text-left">
