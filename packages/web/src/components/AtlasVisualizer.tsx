      ...
      {selectedArch === 'atlas2' ? (
        <div>
          <div className="grid grid-cols-1 md:grid-cols-6 gap-2 mb-6">
            <div className="p-3.5 rounded-xl bg-slate-950 border border-[#00f0ff]/30 text-center">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-emerald-500/40 text-center bg-emerald-950/20">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-red-500/40 bg-red-950/20">
